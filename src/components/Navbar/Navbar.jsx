...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition backdrop-blur-md duration-300 px-4 sm:px-6 md:px-10 lg:px-[15vw] xl:px-[20vw] ${isScrolled
      ? 'bg-white dark:bg-[#050414] bg-opacity-80 backdrop-blur-xl'
      : 'bg-transparent'
      }`}>
      <div className="flex items-center justify-between py-4 text-white">
        ...
        <motion.div
          ...
          className="text-base sm:text-lg font-semibold cursor-pointer whitespace-nowrap text-gray-700 dark:text-gray-300">
        ...
        <ul className="hidden md:flex gap-4 lg:gap-8 text-sm lg:text-base text-gray-700 dark:text-gray-300">
          {menuItems.map((item) => (
            <li
        ...
        <div className="hidden md:flex items-center gap-3">
          <motion.a
            ...
            animate={{ y: isJumping ? -50 : 0 }} // Move up by 50px when jumping
            transition={{ duration: 0.5, type: "spring", stiffness: 100, damping: 10 }} // Spring physics for a natural bounce
            href="https://github.com/KOTADIYABHARGAV" target="_blank" rel="noopener noreferrer" className="hover:text-[#8245ec] text-gray-700 dark:text-gray-300">
            <FaGithub size={20} />
          </motion.a>
          <motion.a
            initial={{ opacity: 0, y: 60 }}
            ...
            animate={{ y: isJumping ? -50 : 0 }} // Move up by 50px when jumping
            transition={{ duration: 0.5, type: "spring", stiffness: 100, damping: 10 }} // Spring physics for a natural bounce
            href="https://www.linkedin.com/in/bhargav-kotadiya/" target="_blank" rel="noopener noreferrer" className="hover:text-[#8245ec] text-gray-700 dark:text-gray-300">
            <FaLinkedin size={20} />
          </motion.a>
        </div>

        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 
              bg-white border-4 border-[#8245ec] w-16 h-16 rounded-full z-20 overflow-hidden shadow-lg items-center justify-center">
            ...
            <div className="md:hidden absolute left-4 sm:left-6 top-0 
              bg-white border-4 border-[#8245ec] w-12 h-12 rounded-full z-10 overflow-hidden shadow-lg">
              <img src={edu.img} alt={edu.school} className="w-full h-full object-cover rounded-full" />
            </div>
            ...
            `}>
              ...
              <div className="w-full max-w-[95%] sm:max-w-[85%] md:max-w-[550px]
                bg-gray-900 border border-white p-6 pt-8 rounded-2xl 
              ...
              ">
                ...
                <p className="text-gray-400 text-sm sm:text-base font-bold">GRADE: {edu.grade}</p>
